...
class HttpProcessor(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        delete_id_match = re.match(r"^/delete/(\d+)/?$", self.path)
        match self.path:
            case "/":
            ...
            case _ if delete_id_match:
                Id = delete_id_match.group(1)
                FormCRUD.form_delete(self, cursor, cnx, Id)
    ...
    def do_GET(self):
        ...
        match self.path:
            ...
            case "/admin":
                FormCRUD.handle_admin(self, cursor, cnx, env)
            case _ if list_id_match:
                Id = list_id_match.group(1)
